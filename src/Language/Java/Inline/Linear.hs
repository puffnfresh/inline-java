...
module Language.Java.Inline.Linear
  ( java
  , Java.imports
...
import qualified Language.Java.Linear as Linear
import qualified Language.Java.Inline as Java
...
java = Java.javaWithConfig Java.QQConfig
    { Java.qqMarker = 'Linear.qqMarker
    , Java.qqCallStatic = 'Linear.callStatic
    , Java.qqCoerce = 'Linear.coerce

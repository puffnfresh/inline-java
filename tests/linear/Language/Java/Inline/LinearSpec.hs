...
module Language.Java.Inline.LinearSpec(spec) where

import Control.Monad.Linear
import Data.Int
import Foreign.JNI (JVMException)
import Foreign.JNI.Linear
import Language.Java.Linear
import Language.Java.Inline.Linear
